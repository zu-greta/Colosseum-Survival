# win rate 30% against student_agent with 10 games and 1.9 seconds.
# no timeout within all moves
# win rate 90% against student_agent with 10 games and 49 seconds.
# change a star with smallest step only
# win rate 40% against student_agent with 10 games and 132 seconds.
# add timeout within all moves
# win rate 40% against student_agent with 10 games and 1.9 seconds.
# reverse back shortest path
# win rate 70% against student_agent with 10 games and 1.9 seconds.
# win rate 56% against student_agent with 50 games and 1.9 seconds.
# remove tie
