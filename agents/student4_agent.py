...
@register_agent("student4_agent")
class Student4Agent(Agent):
    """
    ...
    def __init__(self):
        super(Student4Agent, self).__init__()
        self.name = "Student4Agent"
        self.dir_map = {
            "u": 0,
            "r": 1,
            "d": 2,
    ...
    class MCTS():
        ...
        def legal_moves(self, chess_board, my_pos, adv_pos, max_step, root):
            ...
            while state_queue:
                ...
                for dir, move in enumerate(self.moves): #for each direction
                    ...
                    new_node = Student4Agent.MCTS(0, 0, root, (x, y), dir)
        ...
        def expand(self, my_pos, adv_pos, max_step, chess_board):
            ...
            pos = (x, y)
            node = Student4Agent.MCTS(0, 0, self, pos, dir)
            return node
    ...
    def step(self, chess_board, my_pos, adv_pos, max_step):
        ...
        children = root.legal_moves(step_board, my_pos, adv_pos, max_step, root) #TODO: change-up legal_moves
        num_childs = 0
        while(num_childs < len(children) and not self.timeout(start_time)): 
            # selection of a good child - either hueristic, random or UCB
            child = root.select_child(children) #TODO: improve select_child
            num_sims = 0
